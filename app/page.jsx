...
const CONTENT = {
  ...
  about: {
    ...
    subtitle: `מניקוריסטית מקצועית ומדריכה בתחום הציפורניים.`,
    paragraphs: [
      `את הדרך שלי התחלתי כבר בגיל 12, מתוך סקרנות ואהבה אמיתית לעולם הציפורניים. במשך 5 שנים לימדתי את עצמי את עולם הציפורניים דרך תרגול, ניסיון וטעייה, חקר בלתי פוסק והמון שעות עבודה, ובגיל 17 כבר התחלתי לבנות את העסק שלי שהחזיק אותי כלכלית וקיבלתי לקוחות באופן מקצועי.`,
      `כמעט עשור בתוך התחום לימד אותי שמקצועיות לא נמדדת רק בתוצאה יפה - אלא בהבנה של מה שאנחנו עושות, למה אנחנו עושות אותו, וביכולת להתאים את העבודה לציפורן וללקוחה שנמצאת מולנו.`,
      `גם היום אני ממשיכה ללמוד, להשתלם ולהעמיק, כי מבחינתי אשת מקצוע טובה אף פעם לא מפסיקה ללמוד.`,
      `וזו גם גישת ההוראה שלי:`,
      `אני לא רוצה ללמד אותך רק איך לבצע. חשוב לי שתביני למה. ומה עומד מאחורי כל דבר.`,
      `שתצאי מהלימודים עם יסודות חזקים, חשיבה מקצועית, ביטחון בקבלת החלטות ויכולת לעבוד באופן עצמאי גם כשאני כבר לא עומדת לידך.`,
      `המטרה שלי היא לא ליצור עוד מישהי שיודעת לעשות ציפורניים, אלא לעזור לך לבנות מקצוע שאת באמת גאה בו. ויכול ללוות אותך לאורך החיים 🤍`,
    ],
  },
    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--cream)' }}>
      ...
      >
        <div>
          ...
          <p className="lede" style={{ color: 'var(--taupe)', fontStyle: 'italic', marginBottom: '1.5rem' }}>
            {CONTENT.about.subtitle}
          </p>
          <div className="space-y-4">
            {CONTENT.about.paragraphs.map((paragraph, i) => (
              <p key={i} style={{ color: 'var(--navy-soft)', lineHeight: '1.8' }}>
                {paragraph}
              </p>
            ))}
          </div>
